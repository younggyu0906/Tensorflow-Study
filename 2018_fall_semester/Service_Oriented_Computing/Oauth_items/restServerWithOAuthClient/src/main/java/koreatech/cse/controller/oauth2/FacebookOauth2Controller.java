...
public class FacebookOauth2Controller {
    private static String facebook_client_id = "495705247591711";      //본인 것으로 추가하기
    private static String facebook_client_secret = "067aaf2b9c35f50662b66328f88bd4f2";  //본인 것으로 추가하기
