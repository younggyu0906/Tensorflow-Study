...
ARCHITECTURE structure OF hw01 IS
...
SIGNAL \ALT_INV_agtb~2_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\ALT_INV_agtb~2_combout\ <= NOT \agtb~2_combout\;
...
-- Equation(s):
-- \agtb~0_combout\ = \a~combout\(3) $ (\a~combout\(0) $ (\a~combout\(1) $ (\a~combout\(2))))
...
-- Equation(s):
-- \agtb~1_combout\ = \b~combout\(1) $ (\b~combout\(3) $ (\b~combout\(0) $ (\b~combout\(2))))
