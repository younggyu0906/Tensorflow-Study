...
-- b[0]	=>  Location: PIN_B12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
\equal~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \equal~0_combout\ = (\b~combout\(0) & ((\a~combout\(1) $ (\b~combout\(1))) # (!\a~combout\(0)))) # (!\b~combout\(0) & ((\a~combout\(0)) # (\a~combout\(1) $ (\b~combout\(1)))))
...
-- pragma translate_on
PORT MAP (
	datain => \ALT_INV_equal~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
	oe => VCC,
