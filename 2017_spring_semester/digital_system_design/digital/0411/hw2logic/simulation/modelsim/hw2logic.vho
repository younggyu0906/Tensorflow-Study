...
-- c	=>  Location: PIN_K5,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF hw2logic IS
...
-- Equation(s):
-- \y_out~0_combout\ = (\d~input_o\ & (((\c~input_o\) # (!\b~input_o\)) # (!\a~input_o\)))
